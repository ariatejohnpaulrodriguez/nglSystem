            ...
            `;
                                                    ...
                                                    <tr>
                                                        <td colspan="5" class="text-center">
                                                            <button type="button" id="add-product"
                                                                ...
                                                                <i class="fas fa-plus"></i> Add Product to Deliver
                                                            </button>
                                                        </td>
                                                    </tr>
                                                </tfoot>
                                    ...
                                    <div class="row no-print">
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-success float-right">
                                                <i class="fas fa-file-invoice"></i> Submit Delivery
                                            </button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <script>
                                    document.getElementById('add-product').addEventListener('click', function () {
                                        ...
                                        tr.innerHTML = `<td><input type="number" class="form-control form-control-sm" name="less_quantity[]" min="1" value="1"></td>
    <td>
        ...
        <button type="button" class="btn btn-danger btn-sm remove-product">
            <i class="fas fa-trash"></i>
                                    ...
                                    document.getElementById('invoice-form').addEventListener('submit', function (e) {
                                        ...
                                        var quantities = document.querySelectorAll('input[name="less_quantity[]"]');
                                        ...
                                        quantities.forEach(function (qtyInput, index) {
                                            ...
                                            xhr.open('POST', 'recieve/product-out.php', true);
                                            xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
                                            xhr.send('product_id=' + productId + '&quantity=' + qty + '&action=less');
